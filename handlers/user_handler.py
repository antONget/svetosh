...
async def process_start_command_user(message: Message, state: FSMContext, bot: Bot) -> None:
    ...
    await message.answer(text=f'Диагностика интеллекта ребёнка позволит:\n'
                              f' ⁃ узнать актуальный уровень его интеллектуальных способностей,\n'
                              f' ⁃ выявить сильные и слабые стороны мозговой деятельности,\n'
                              f' ⁃ понять как скорректировать пробелы.')
    await asyncio.sleep(2)
